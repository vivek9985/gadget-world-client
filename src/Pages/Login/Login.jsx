        ...
        <div className="w-11/12 mx-auto shadow md:mt-0 sm:max-w-md xl:p-0 bg-fuchsia-200 overflow-hidden rounded-2xl">
          <div className="w-full bg-transparent p-5 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form onSubmit={loginHandler} className="space-y-4 md:space-y-6">
              ...
              <button
                type="submit"
                className="w-full text-white bg-purple-500 hover:bg-gray-900 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg px-5 py-2.5 text-center"
              >
                Login
              </button>

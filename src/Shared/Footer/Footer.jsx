...
const Footer = () => {
  return (
    <div className="bg-[#f8f8f8]">
      <div className="w-10/12 mx-auto grid grid-cols-1 md:grid-cols-2 py-6">
        <div className="flex flex-col items-start md:items-start justify-center gap-4 py-3">
          <div className="flex items-center">
            <FaPhone className="text-base md:text-lg mr-1 text-blue-400"></FaPhone>
            <h2 className="text-lg font-medium text-gray-900">Conact :</h2>
        ...
        <div className="py-3 flex items-center justify-start md:justify-end">
          <div className="">
